...
contract CafeChef is Ownable {
    ...
    event StopReward(uint256 bonusEndBlock);
    event SetFeeAddress(address user, address newFeeAddress);
    ...
    function changeFeeAddress(address _newFeeAddress) external onlyOwner {
        ...
        emit SetFeeAddress(msg.sender, _newFeeAddress);
    }
